                ...
                <div
                    ...
                    <div class="bg-gray-50 px-4 py-4 flex justify-between text-center border-t border-gray-100">
                        ...
                        <div class="w-1/2 px-2">
                            <span
                                class="block font-bold text-lg {{ $house->active_bookings_count > 0 ? 'text-gray-500' : 'text-red-600' }}">{{ \Carbon\Carbon::parse($house->booking_date)->format('d M') }}</span>
                            <span
                                class="text-[10px] uppercase font-bold tracking-wide {{ $house->active_bookings_count > 0 ? 'text-red-600' : 'text-gray-500' }}">
                                {{ $house->active_bookings_count > 0 ? 'Booked' : 'Available' }}
                            </span>
                        </div>
                    </div>
