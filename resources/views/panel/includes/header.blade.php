<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
    ...
    <button type="button" onclick="openFilterModal()"
        class="ml-3 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-md transition flex items-center"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2" style="overflow:hidden;">
                                    <h6 class="fw-normal mb-0"
                                        ...
                                        {{ $msg->is_mine ? 'You' : $other->name }}:
                                        {{ \Illuminate\Support\Str::limit($msg->body, 30) }}
                                    </h6>
