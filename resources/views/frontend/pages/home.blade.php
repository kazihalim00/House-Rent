...
@section('content')
    ...
    <div class="section" id="popularhouses">
        ...
        <div class="row mb-5 align-items-center">
            ...
            <div class="col-12 position-relative d-flex align-items-center">
                ...
                <!-- Title (true center) -->
                <h2 class="font-weight-bold text-primary heading m-0 w-100 text-center">
                    Popular Properties
                </h2>

                <!-- Button (right side, fixed size) -->
                <div class="position-absolute end-0">
                    <a href="{{ route('house-detail') }}" class="btn btn-primary text-white py-3 px-4">
                        View all properties
                    </a>
                </div>
    ...
    $displayImage = $houseImages[0] ?? 'default.jpg';
                    ...
                    <div class="property-item">
                        ...
                        <a href="{{ route('panel.pages.show', $house->id) }}" class="img property-img-wrapper">
                        ...
                        <div class="property-content">
                            ...
                            <div class="price mb-2">
                                <span>৳ {{ number_format($house->home_price) }}</span>
                            </div>

                            <span class="d-block mb-1 text-black-50">
                                {{ $house->house_name }}
                            </span>
        ...
        <div class="container">
            ...
            <div class="row mb-5 align-items-center">
                ...
                <div class="col-12 text-center position-relative">
                    ...
                    <div class="position-absolute end-0 top-50 translate-middle-y d-flex align-items-center">

                        <span class="btn btn-light rounded-pill px-4 py-2 me-2" data-bs-target="#testimonialCarousel"
                            data-bs-slide="prev" style="cursor:pointer; font-size:14px; font-weight:bold;">
                            Prev
                        </span>

                        <span class="btn btn-light rounded-pill px-4 py-2" data-bs-target="#testimonialCarousel"
                            data-bs-slide="next" style="cursor:pointer; font-size:14px; font-weight:bold;">
                            Next
                        </span>
                        ...
                        @foreach($reviews as $key => $review)
                            ...
                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                ...
                                <div class="testimonial text-center px-3">
                                    ...
                                    <p class="text-black-50 mt-3 font-weight-bold">
                                        Verified Customer
                                    </p>
                        ...
                        <div class="carousel-item active">
                            <div class="text-center w-100">
                                <p class="text-muted italic">
                                    No reviews yet. Be the first to leave a review from your dashboard!
                                </p>
                            </div>
                        </div>
    ...
    <div class="section section-4 bg-light" id="about">
        <div class="container">
            ...
            <style>
                ...
                /* 🔥 hover zoom (better visibility) */
                .property-img-wrapper:hover .house-img {
