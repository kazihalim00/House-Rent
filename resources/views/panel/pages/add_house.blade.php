...
@section('content')
    ...
    <div class="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl p-8">
            ...
            @if (session('success'))
                <div
                    class="mb-6 p-4 bg-green-500/10 border border-green-500/50 text-green-400 shadow-md rounded-xl flex justify-between items-center">
                    <span>{{ session('success') }}</span>
                    <button type="button" onclick="this.parentElement.style.display='none'" class="text-green-400 font-bold">
                        &times;
                    </button>
                </div>
            @endif
            ...
            @if ($errors->any())
                <div class="mb-6 p-4 bg-red-500/10 border border-red-500/50 text-red-400 shadow-md rounded-xl">
