        ...
        <div class="form-container">
            ...
            <form action="{{ route('book.store') }}" method="POST">
                <div style="margin-bottom: 2rem">
                    ...
                    <p class="form-desc">Booking for: <strong>{{ $house->house_name }}</strong></p>
                    <p class="form-desc">
                ...
                <input type="text" name="guest_name" id="guest_name" class="form-input" value="{{ Auth::user()->name }}" required />
                
                <label for="guest_email" class="form-label">Email Address</label>
                <input type="email" name="guest_email" id="guest_email" class="form-input" value="{{ Auth::user()->email }}" required />

                <label for="guest_phone" class="form-label">Phone Number</label>
                <input type="tel" name="guest_phone" id="guest_phone" class="form-input" placeholder="Enter your phone number"
                    required />
